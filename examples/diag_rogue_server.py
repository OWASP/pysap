    ...
    def make_login_screen(self):
        return [
            ...
            SAPDiagItem(item_value=SAPDiagDyntAtom(items=[SAPDiagDyntAtomItem(text='Client            ', maxnrchars=18, dlg_flag_2=2, atom_length=37, etype=132, attr_DIAG_BSD_PROTECTED=1L, mlen=18, dlen=18, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
                                                          ...
                                                          SAPDiagDyntAtomItem(row=2, dlg_flag_2=3, atom_length=24, text='RSYST-BNAME', etype=114, attr_DIAG_BSD_PROTECTED=1L, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
                                                          SAPDiagDyntAtomItem(text='?           ', attr_DIAG_BSD_YES3D=1L, maxnrchars=12, row=2, dlg_flag_2=1, atom_length=31, etype=130, mlen=12, dlen=12, block=1, col=20),
                                                          SAPDiagDyntAtomItem(attr_DIAG_BSD_YES3D=1L, row=2, dlg_flag_2=1, atom_length=24, text='RSYST-BNAME', etype=114, block=1, col=20),
                                                          SAPDiagDyntAtomItem(attr_DIAG_BSD_YES3D=1L, row=2, dlg_flag_2=1, atom_length=82, text='<Propertybag><DefaultTooltip>User name</DefaultTooltip></Propertybag>', etype=120, block=1, col=20),
                                                          SAPDiagDyntAtomItem(text='@\\QUp to 40 Chars (Case-Sens.)@Password             ', maxnrchars=52, row=3, dlg_flag_2=3, dlg_flag_1=4, atom_length=71, etype=132, attr_DIAG_BSD_PROTECTED=1L, mlen=18, dlen=52, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
                                                          SAPDiagDyntAtomItem(row=3, dlg_flag_2=3, dlg_flag_1=4, atom_length=24, text='RSYST-BCODE', etype=114, attr_DIAG_BSD_PROTECTED=1L, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
                                                          SAPDiagDyntAtomItem(text='?                                       ', attr_DIAG_BSD_YES3D=1L, maxnrchars=40, row=3, dlg_flag_2=1, dlg_flag_1=4, atom_length=59, etype=130, attr_DIAG_BSD_INVISIBLE=1L, mlen=12, dlen=40, block=1, col=20),
                                                          SAPDiagDyntAtomItem(attr_DIAG_BSD_YES3D=1L, row=3, dlg_flag_2=1, dlg_flag_1=4, atom_length=24, text='RSYST-BCODE', etype=114, attr_DIAG_BSD_INVISIBLE=1L, block=1, col=20),
                                                          SAPDiagDyntAtomItem(attr_DIAG_BSD_YES3D=1L, row=3, dlg_flag_2=1, dlg_flag_1=4, atom_length=86, text='<Propertybag><DefaultTooltip>User password</DefaultTooltip></Propertybag>', etype=120, attr_DIAG_BSD_INVISIBLE=1L, block=1, col=20),
                                                          SAPDiagDyntAtomItem(text='Language          ', maxnrchars=18, row=5, dlg_flag_2=2, atom_length=37, etype=132, attr_DIAG_BSD_PROTECTED=1L, mlen=18, dlen=18, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
                                                          SAPDiagDyntAtomItem(row=5, dlg_flag_2=2, atom_length=24, text='RSYST-LANGU', etype=114, attr_DIAG_BSD_PROTECTED=1L, attr_DIAG_BSD_PROPFONT=1L, block=1, col=1),
