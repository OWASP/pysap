...
class SAPRFCEXTEND(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenPaddedField("short_dest_name", b"", length=8),
        StrFixedLenPaddedField("ncpic_lu", b"", length=8),
        StrFixedLenPaddedField("ncpic_tp", b"", length=8),
        ByteEnumKeysField("ctype", 0x45, cpic_ctypes),
        ByteField("clientInfo", 0x01),
        StrFixedLenField("ncpic_parameters_padd", b"\x00\x00", length=2),
...
class SAPRFCDTStruct(PacketNoPadded):
    ...
    fields_desc = [
        ...
        StrFixedLenField("padd1", b"\x00" * 8, length=8),
        StrFixedLenField("root_id", b"\x00" * 16, length=16),
        StrFixedLenField("conn_id", b"\x00" * 16, length=16),
        ...
        StrFixedLenPaddedField("long_lu", b"", padd="\x00", length=128),
        StrFixedLenField("padd3", b"\x00" * 16, length=16),
        StrFixedLenPaddedField("user", b"", length=12),
        StrFixedLenField("padd4", b"\x20" * 8, length=8),
        StrFixedLenField("padd5", b"\x00" * 4, length=4),
        StrFixedLenField("padd6", b"\x20" * 12, length=12),
        StrFixedLenField("padd7", b"\x00" * 16, length=16),
        IPField("addr_ipv4", "0.0.0.0"),
        StrFixedLenField("padd8", b"\x00" * 4, length=4),
        StrFixedLenPaddedField("long_tp", b"", padd="\x00", length=64),
    ]
...
class SAPCPICSUFFIX(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("suff_padd1", b"\x10\x04\x02", length=3),
        FieldLenField("suff_unk1_len", None, length_of="suff_unk1", fmt="!H"),
        StrLenField("suff_unk1", b"", length_from=lambda pkt: pkt.suff_unk1_len),
        StrFixedLenField("suff_padd2", b"\x10\x04\x0b", length=3),
        FieldLenField("suff_unk2_len", None, length_of="suff_unk2", fmt="!H"),
        StrLenField("suff_unk2", b"", length_from=lambda pkt: pkt.suff_unk2_len),
        StrFixedLenField("suff_padd3", b"\x10\x04\x04", length=3),
        FieldLenField("suff_unk3_len", None, length_of="suff_unk3", fmt="!H"),
        StrLenField("suff_unk3", b"", length_from=lambda pkt: pkt.suff_unk3_len),
        StrFixedLenField("suff_padd4", b"\x10\x04\x0d", length=3),
        FieldLenField("suff_unk4_len", None, length_of="suff_unk4", fmt="!H"),
        StrLenField("suff_unk4", b"", length_from=lambda pkt: pkt.suff_unk4_len),
        StrFixedLenField("suff_padd5", b"\x10\x04\x16", length=3),
        FieldLenField("suff_unk5_len", None, length_of="suff_unk5", fmt="!H"),
        StrLenField("suff_unk5", b"", length_from=lambda pkt: pkt.suff_unk5_len),
        StrFixedLenField("suff_padd6", b"\x10\x04\x17", length=3),
        FieldLenField("suff_unk6_len", None, length_of="suff_unk6", fmt="!H"),
        StrLenField("suff_unk6", b"", length_from=lambda pkt: pkt.suff_unk6_len),
        StrFixedLenField("suff_padd7", b"\x10\x04\x19", length=3),
        FieldLenField("suff_unk7_len", None, length_of="suff_unk7", fmt="!H"),
        StrLenField("suff_unk7", b"", length_from=lambda pkt: pkt.suff_unk7_len),
        StrFixedLenField("suff_padd8", b"\x10\x04\x1e", length=3),
        FieldLenField("suff_unk8_len", None, length_of="suff_unk8", fmt="!H"),
        StrLenField("suff_unk8", b"", length_from=lambda pkt: pkt.suff_unk8_len),
        StrFixedLenField("suff_padd9", b"\x10\x04\x25", length=3),
        FieldLenField("suff_unk9_len", None, length_of="suff_unk9", fmt="!H"),
        StrLenField("suff_unk9", b"", length_from=lambda pkt: pkt.suff_unk9_len),
        ...
        ConditionalField(StrLenField("suff_unk10", b"", length_from=lambda pkt: pkt.suff_unk10_len), lambda pkt: pkt.suff_unk9 == "\x00\x01"),
        ...
        ConditionalField(StrLenField("suff_cli1", b"", length_from=lambda pkt: pkt.suff_cli1_len), lambda pkt: pkt.suff_unk9 == "\x00\x01"),  # ip or OS name here
        ...
        ConditionalField(StrLenField("suff_cli2", b"", length_from=lambda pkt: pkt.suff_cli2_len), lambda pkt: pkt.suff_unk9 == "\x00\x01"),  # browser name here
        ...
        ConditionalField(StrLenField("suff_cli3", b"", length_from=lambda pkt: pkt.suff_cli3_len), lambda pkt: pkt.suff_unk9 == "\x00\x01"),  # office name here

        StrFixedLenField("suff_padd14", b"\x10\x04\x24", length=3),
        FieldLenField("suff_unk14_len", None, length_of="suff_unk14", fmt="!H"),
        StrLenField("suff_unk14", b"", length_from=lambda pkt: pkt.suff_unk14_len),
        StrFixedLenField("suff_padd15", b"\x10\x04\x24", length=3),
        FieldLenField("suff_unk15_len", None, length_of="suff_unk15", fmt="!H"),
        StrLenField("suff_unk15", b"", length_from=lambda pkt: pkt.suff_unk15_len),  # ip here
    ]
...
class SAPCPICPARAM(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("pref", b"\x01\x00\x0c\x29", length=4),
        StrFixedLenField("param1", b"", length=4),
        StrFixedLenField("param2", b"", length=11),
        StrFixedLenField("param_sess_1", b"", length=2),
        StrFixedLenField("param_sess_2", b"", length=4),
        IPField("mask", ""),
        IPField("ip", ""),
        IntField("flag", 1),
    ]
...
class SAPCPICPARAM2(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("param1", b"", length=8),
        IPField("mask", ""),
        IPField("ip", ""),
    ]
...
class SAPRFCTHStruct(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("th_eyec1", b"*TH*", length=4),
        ByteField("th_version", 3),
        ShortField("th_len", 230),
        ShortField("th_trace_flag", None),
        StrFixedLenPaddedField("th_sysid",b"", length=32),
        ShortField("th_serevice", 1),
        StrFixedLenPaddedField("th_userid", b"SAP*", length=32),
        StrFixedLenPaddedField("th_action", b"", length=40),
...
class SAPRFXPG(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("xpg_padd100", b"\x05\x12\x02\x05", length=4),
        FieldLenField("xpg_convid_l_len", None, length_of="xpg_convid_l", fmt="!H"),
        StrLenField("xpg_convid_l", b"CONVID", length_from=lambda pkt: pkt.xpg_convid_l_len),

        StrFixedLenField("xpg_padd101", b"\x02\x05\x02\x05", length=4),
        FieldLenField("xpg_strstat_l_len", None, length_of="xpg_strstat_l", fmt="!H"),
        StrLenField("xpg_strstat_l", b"STRTSTAT", length_from=lambda pkt: pkt.xpg_strstat_l_len),

        StrFixedLenField("xpg_padd102", b"\x02\x05\x02\x05", length=4),
        FieldLenField("xpg_xpgid_l_len", None, length_of="xpg_xpgid_l", fmt="!H"),
        StrLenField("xpg_xpgid_l", b"XPGID", length_from=lambda pkt: pkt.xpg_xpgid_l_len),

        StrFixedLenField("xpg_padd103", b"\x02\x05\x02\x01", length=4),
        FieldLenField("xpg_extprog_l_len", None, length_of="xpg_extprog_l", fmt="!H"),
        StrLenField("xpg_extprog_l", b"EXTPROG", length_from=lambda pkt: pkt.xpg_extprog_l_len),

        StrFixedLenField("xpg_padd104", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_extprog_val_len", None, length_of="xpg_extprog_val", fmt="!H"),
        StrLenField("xpg_extprog_val", b"whoami", length_from=lambda pkt: pkt.xpg_extprog_val_len),

        StrFixedLenField("xpg_padd105", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_longparam_l_len", None, length_of="xpg_longparam_l", fmt="!H"),
        StrLenField("xpg_longparam_l", b"LONG_PARAMS", length_from=lambda pkt: pkt.xpg_longparam_l_len),

        StrFixedLenField("xpg_padd106", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_longparam_val_len", None, length_of="xpg_longparam_val", fmt="!H"),
        StrLenField("xpg_longparam_val", b"", length_from=lambda pkt: pkt.xpg_longparam_val_len),

        StrFixedLenField("xpg_padd107", b"\x02\x03\x02\x01", length=4),
        ...
        StrFixedLenField("xpg_padd108", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_param_val_len", None, length_of="xpg_param_val", fmt="!H"),
        StrLenField("xpg_param_val", b"", length_from=lambda pkt: pkt.xpg_param_val_len),

        StrFixedLenField("xpg_padd109", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_stderrcntl_l_len", None, length_of="xpg_stderrcntl_l", fmt="!H"),
        StrLenField("xpg_stderrcntl_l", b"STDERRCNTL", length_from=lambda pkt: pkt.xpg_stderrcntl_l_len),

        StrFixedLenField("xpg_padd110", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_stderrcntl_val_len", None, length_of="xpg_stderrcntl_val", fmt="!H"),
        StrLenField("xpg_stderrcntl_val", b"", length_from=lambda pkt: pkt.xpg_stderrcntl_val_len),

        StrFixedLenField("xpg_padd111", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_stdincntl_l_len", None, length_of="xpg_stdincntl_l", fmt="!H"),
        StrLenField("xpg_stdincntl_l", b"STDINCNTL", length_from=lambda pkt: pkt.xpg_stdincntl_l_len),

        StrFixedLenField("xpg_padd112", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_stdincntl_val_len", None, length_of="xpg_stdincntl_val", fmt="!H"),
        StrLenField("xpg_stdincntl_val", b"PARAMS", length_from=lambda pkt: pkt.xpg_stdincntl_val_len),

        StrFixedLenField("xpg_padd113", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_stdoutcntl_l_len", None, length_of="xpg_stdoutcntl_l", fmt="!H"),
        StrLenField("xpg_stdoutcntl_l", b"STDOUTCNTL", length_from=lambda pkt: pkt.xpg_stdoutcntl_l_len),

        StrFixedLenField("xpg_padd114", b"\x02\x01\x02\x03", length=4),
        ...
        StrFixedLenField("xpg_padd115", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_termcntl_l_len", None, length_of="xpg_termcntl_l", fmt="!H"),
        StrLenField("xpg_termcntl_l", b"TERMCNTL", length_from=lambda pkt: pkt.xpg_termcntl_l_len),

        StrFixedLenField("xpg_padd116", b"\x02\x01\x02\x03", length=4),
        FieldLenField("xpg_termcntl_val_len", None, length_of="xpg_termcntl_val", fmt="!H"),
        StrLenField("xpg_termcntl_val", b"", length_from=lambda pkt: pkt.xpg_termcntl_val_len),

        StrFixedLenField("xpg_padd117", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_tracecntl_l_len", None, length_of="xpg_tracecntl_l", fmt="!H"),
        StrLenField("xpg_tracecntl_l", b"TRACECNTL", length_from=lambda pkt: pkt.xpg_tracecntl_l_len),

        StrFixedLenField("xpg_padd118", b"\x02\x03\x02\x01", length=4),
        FieldLenField("xpg_tracecntl_val_len", None, length_of="xpg_tracecntl_val", fmt="!H"),
        StrLenField("xpg_tracecntl_val", b"", length_from=lambda pkt: pkt.xpg_tracecntl_val_len),

        StrFixedLenField("xpg_padd119", b"\x02\x03\x03\x01", length=4),
        FieldLenField("xpg_log_l_len", None, length_of="xpg_log_l", fmt="!H"),
        StrLenField("xpg_log_l", b"LOG", length_from=lambda pkt: pkt.xpg_log_l_len),

        StrFixedLenField("xpg_padd120", b"\x03\x01\x03\x30", length=4),
        FieldLenField("xpg_log_val1_len", None, length_of="xpg_log_val1", fmt="!H"),
        StrLenField("xpg_log_val1", b"", length_from=lambda pkt: pkt.xpg_log_val1_len),

        StrFixedLenField("xpg_padd121", b"\x03\x30\x03\x02", length=4),
        FieldLenField("xpg_unk1_len", None, length_of="xpg_unk1", fmt="!H"),
        StrLenField("xpg_unk1", b"", length_from=lambda pkt: pkt.xpg_unk1_len),
    ]
...
class DEF_FIELDS(PacketNoPadded):
    ...
    """
    fields_desc = [
        StrFixedLenField("start_padd", b"", length=4),
        FieldLenField("start_field1_len", None, length_of="start_field1", fmt="!H"),
        StrLenField("start_field1", b"", length_from=lambda pkt: pkt.start_field1_len),
    ]
...
class SAPRFXPG_END(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("xpg_end_padd001", b"\x05\x12\x02\x05", length=4),
        FieldLenField("xpg_end_ecode_l_len", None, length_of="xpg_end_ecode_l", fmt="!H"),
        StrLenField("xpg_end_ecode_l", b"EXITCODE", length_from=lambda pkt: pkt.xpg_end_ecode_l_len),

        StrFixedLenField("xpg_end_padd002", b"\x02\x05\x02\x05", length=4),
        FieldLenField("xpg_end_estat_l_len", None, length_of="xpg_end_estat_l", fmt="!H"),
        StrLenField("xpg_end_estat_l", b"STRTSTAT", length_from=lambda pkt: pkt.xpg_end_estat_l_len),

        StrFixedLenField("xpg_end_padd003", b"\x02\x05\x03\x01", length=4),
        FieldLenField("xpg_end_log_l_len", None, length_of="xpg_end_log_l", fmt="!H"),
        StrLenField("xpg_end_log_l", b"LOG", length_from=lambda pkt: pkt.xpg_end_log_l_len),

        StrFixedLenField("xpg_end_padd004", b"\x03\x01\x03\x30", length=4),
        FieldLenField("xpg_end_unk1_len", None, length_of="xpg_end_unk1", fmt="!H"),
        StrLenField("xpg_end_unk1", b"\x00\x00\x00\x01", length_from=lambda pkt: pkt.xpg_end_unk1_len),

        StrFixedLenField("xpg_end_padd005", b"\x03\x30\x03\x02", length=4),
        FieldLenField("xpg_end_unk2_len", None, length_of="xpg_end_unk2", fmt="!H"),
        StrLenField("xpg_end_unk2", b"\x00\x00\x00\x80\x00\x00\x00\x00", length_from=lambda pkt: pkt.xpg_end_unk2_len),
    ]
...
class SAPCPIC2(PacketNoPadded):
    ...
    fields_desc = [
        StrFixedLenField("cpic_padd015_1", b"", length=2),
        ...
        StrFixedLenField("cpic_padd016", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_convid_label", b"", length_from=lambda pkt: pkt.cpic_convid_label_len), lambda pkt: pkt.cpic_padd016 == cpic_padd["cpic_convid_label_padd"]),

        StrFixedLenField("cpic_padd017", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_kernel3", b"", length_from=lambda pkt: pkt.cpic_kernel3_len), lambda pkt: pkt.cpic_padd017 == cpic_padd["cpic_kernel3_padd"]),

        StrFixedLenField("cpic_padd018", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_RFC_f", b"", length_from=lambda pkt: pkt.cpic_RFC_f_len), lambda pkt: pkt.cpic_padd018 == cpic_padd["cpic_RFC_f_padd"]),

        StrFixedLenField("cpic_padd019", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk4", b"", length_from=lambda pkt: pkt.cpic_unk4_len), lambda pkt: pkt.cpic_padd019 == cpic_padd["cpic_unk4_padd"]),
        ...
        StrFixedLenField("cpic_padd021", b"", length=4),
        ...
        StrFixedLenField("cpic_padd022", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk6", b"", length_from=lambda pkt: pkt.cpic_unk6_len), lambda pkt: pkt.cpic_padd022 == cpic_padd["cpic_unk6_padd"]),

        StrFixedLenField("cpic_padd023", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk7", b"", length_from=lambda pkt: pkt.cpic_unk7_len), lambda pkt: pkt.cpic_padd023 == cpic_padd["cpic_unk7_padd"]),
        ...
        StrFixedLenField("cpic_end_padd", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_end", b"", length_from=lambda pkt: pkt.cpic_end_len), lambda pkt: pkt.cpic_end_padd == cpic_padd["cpic_end_padd"]),

        StrFixedLenField("cpic_end_sig", b"\x00\x00\xff\xff", length=4),
    ]
...
class SAPCPIC(PacketNoPadded):
    ...
    name = "SAP CPIC Packet"
    fields_desc = [
        StrFixedLenField("cpic_start_padd", b"", length=4),
        ...
        StrFixedLenField("cpic_padd0003", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk02", b"", length_from=lambda pkt: pkt.cpic_unk02_len), lambda pkt: pkt.cpic_padd0003 == cpic_padd["cpic_unk02_padd"]),

        StrFixedLenField("cpic_padd0002", b"", length=4),
        ...
        StrFixedLenField("cpic_padd0001", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk00", b"", length_from=lambda pkt: pkt.cpic_unk00_len), lambda pkt: pkt.cpic_padd0001 == cpic_padd["cpic_unk00_padd"]),

        StrFixedLenField("cpic_padd001", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_ip", b"", length_from=lambda pkt: pkt.cpic_ip_len), lambda pkt: pkt.cpic_padd001 == cpic_padd["cpic_ip_padd"]),

        StrFixedLenField("cpic_padd002", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_ip2", b"", length_from=lambda pkt: pkt.cpic_ip2_len), lambda pkt: pkt.cpic_padd002 == cpic_padd["cpic_ip_padd2"]),

        StrFixedLenField("cpic_padd003", b"", length=4),
        ...
        StrFixedLenField("cpic_padd004", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_rfc_type", b"", length_from=lambda pkt: pkt.cpic_rfc_type_len), lambda pkt: pkt.cpic_padd004 == cpic_padd["cpic_rfc_type_padd"]),

        StrFixedLenField("cpic_padd005", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_kernel1", b"", length_from=lambda pkt: pkt.cpic_kernel1_len), lambda pkt: pkt.cpic_padd005 == cpic_padd["cpic_kernel1_padd"]),

        StrFixedLenField("cpic_padd006", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_kernel2", b"", length_from=lambda pkt: pkt.cpic_kernel2_len), lambda pkt: pkt.cpic_padd006 == cpic_padd["cpic_kernel2_padd"]),

        StrFixedLenField("cpic_padd007", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_dest", b"", length_from=lambda pkt: pkt.cpic_dest_len), lambda pkt: pkt.cpic_padd007 == cpic_padd["cpic_dest_padd"]),

        StrFixedLenField("cpic_padd008", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_program", b"", length_from=lambda pkt: pkt.cpic_program_len), lambda pkt: pkt.cpic_padd008 == cpic_padd["cpic_program_padd"]),

        StrFixedLenField("cpic_padd009", b"", length=4),
        ...
        StrFixedLenField("cpic_padd010", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_cli_nbr1", b"", length_from=lambda pkt: pkt.cpic_cli_nbr1_len), lambda pkt: pkt.cpic_padd010 == cpic_padd["cpic_cli_nbr1_padd"]),

        StrFixedLenField("cpic_padd011", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk1", b"", length_from=lambda pkt: pkt.cpic_unk1_len), lambda pkt: pkt.cpic_padd011 == cpic_padd["cpic_unk1_padd"]),

        StrFixedLenField("cpic_padd012", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_username2", b"", length_from=lambda pkt: pkt.cpic_username2_len), lambda pkt: pkt.cpic_padd012 == cpic_padd["cpic_username2_padd"]),

        StrFixedLenField("cpic_padd013", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_cli_nbr2", b"", length_from=lambda pkt: pkt.cpic_cli_nbr2_len), lambda pkt: pkt.cpic_padd013 == cpic_padd["cpic_cli_nbr2_padd"]),

        StrFixedLenField("cpic_padd014", b"", length=4),
        ...
        ConditionalField(StrLenField("cpic_unk2", b"", length_from=lambda pkt: pkt.cpic_unk2_len), lambda pkt: pkt.cpic_padd014 == cpic_padd["cpic_unk2_padd"]),

        # dirty fix for the last packet
        StrFixedLenField("cpic_padd015_0", b"", length=2),  # <---- last packets starts here
        StrFixedLenField("cpic_padd015_1", b"", length=2),
        ConditionalField(FieldLenField("cpic_some_params_len", None, length_of="some_cpic_params", fmt="!H"), lambda pkt: pkt.cpic_padd015_1 == cpic_padd["cpic_some_params_1_padd"]),
        ConditionalField(PacketListField("some_cpic_params", None, SAPCPICPARAM, length_from=lambda pkt: pkt.cpic_some_params_len), lambda pkt: pkt.cpic_padd015_1 == cpic_padd["cpic_some_params_1_padd"]),
        ...
        StrFixedLenField("cpic_padd020", b"", length=4),
        ConditionalField(FieldLenField("cpic_th_struct_len", None, length_of="cpic_th_struct", fmt="!H"), lambda pkt: pkt.cpic_padd020 == cpic_padd["cpic_th_struct_padd"]),
        ConditionalField(PacketListField("cpic_th_struct", None, SAPRFCTHStruct, length_from=lambda pkt: pkt.cpic_th_struct_len), lambda pkt: pkt.cpic_padd020 == cpic_padd["cpic_th_struct_padd"]),
...
class SAPRFC(PacketNoPadded):
    ...
    fields_desc = [
        ...
        ConditionalField(StrFixedLenPaddedField("service", b"", length=10), lambda pkt: pkt.req_type == 0x03),
        ConditionalField(StrFixedLenField("codepage", b"1100", length=4), lambda pkt: pkt.req_type == 0x03),
        ConditionalField(StrFixedLenField("padd2", b"\x00" * 6, length=6), lambda pkt: pkt.req_type == 0x03),
        ConditionalField(StrFixedLenPaddedField("lu", b"", length=8), lambda pkt: pkt.req_type == 0x03),
        ConditionalField(StrFixedLenPaddedField("tp", b"", length=8), lambda pkt: pkt.req_type == 0x03),
        ConditionalField(StrFixedLenPaddedField("conversation_id", b"", length=8), lambda pkt: pkt.req_type == 0x03),
        ...
        ConditionalField(StrFixedLenField("padd_v12", b"\x00" * 61, length=61),
                         lambda pkt: pkt.version < 3 and pkt.req_type == 0x09),
        ConditionalField(StrFixedLenField("padd_v12", b"\x00" * 62, length=62),
                         lambda pkt: pkt.version < 3 and pkt.req_type not in [0x03, 0x09]),
        ConditionalField(StrFixedLenField("padd_v3", b"\x00" * 133, length=133),
                         lambda pkt: pkt.version == 3 and pkt.req_type == 0x09),
        ConditionalField(StrFixedLenField("padd_v3", b"\x00" * 134, length=134),
                         lambda pkt: pkt.version == 3 and pkt.req_type not in [0x03, 0x09]),
        ...
        ConditionalField(StrFixedLenField("conv_id", b'0', 8), lambda pkt: pkt.version == 0x6),
        ...
        ConditionalField(StrFixedLenField("cm_ok_padd", b'0', 32), lambda pkt: pkt.version == 0x6 and "SYNC_CPIC_FUNCTION" in str(pkt.info) and "GW_WITH_CODE_PAGE" not in str(pkt.info3)),  # chipik
        ConditionalField(IntField("codepage_size1", 0,), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(StrFixedLenField("codepage_padd1", b'0', 4), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(IntField("codepage_size2", 0,), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(StrFixedLenField("codepage_padd2", b'0', 4), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(StrFixedLenField("codepage_padd3", b'0', 4), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(StrFixedLenField("codepage", b'0', 5), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
        ConditionalField(StrFixedLenField("codepage_padd2", b'0', 7), lambda pkt: pkt.version == 0x6 and "GW_WITH_CODE_PAGE" in str(pkt.info3)),  # chipik
