...
- Full remaining Python 3 migration ([Red Rays](https://redrays.io/), [#84](https://github.com/OWASP/pysap/pull/84); [@vah13](https://github.com/vah13)).
- Source code review and change alignment ([@codehorse87](https://github.com/codehorse87)).
- Functional testing by various OWASP CBAS community members
- `pysapcompress` model has been migrated from C code to a pure Python implementation. This makes the project more portable and packages easy to manage. Implementation is based on the TypeScript [sapcomp library by Max Jäger](https://git.sr.ht/~xje4/sapcomp) ([@randomstr1ng](https://github.com/randomstr1ng), [@codehorse87](https://github.com/codehorse87), [#86](https://github.com/OWASP/pysap/pull/86)).
- Example scripts: Migrated the example scripts to Python 3 and fixed bytes/text handling, output formatting and routing edge cases across the migrated tools ([@randomstr1ng](https://github.com/randomstr1ng), [#90](https://github.com/OWASP/pysap/pull/90)).
...
- `pysap/utils/fields.py`: Fixed string/byte handling in Scapy field helpers and added regression tests ([Tyrox](https://github.com/DominikHolzapfel), [#92](https://github.com/OWASP/pysap/pull/92)).
- Honeysap compatibility: Added NWRFC support, RFC crypto helpers, NI/RFC compatibility fixes, keepalive handling and UTF-16LE field round-trip tests ([@randomstr1ng](https://github.com/randomstr1ng), Hackbarth, [#93](https://github.com/OWASP/pysap/pull/93)).
...
- `pysap/SAPCredv2.py`: Added subject fields instead of commonName for LPS-enabled credentials ([@rstenet](https://github.com/rstenet), [#35](https://github.com/OWASP/pysap/issues/35)).
- `pysap/SAPCredv2.py`: Added cipher format version 1 with 3DES ([@rstenet](https://github.com/rstenet), [#37](https://github.com/OWASP/pysap/pull/37); related [#35](https://github.com/OWASP/pysap/issues/35)).
...
- `pysap/SAPRouter.py`: Added route-string support in `SAPRouterNativeProxy` ([@gloomicious](https://github.com/gloomicious), [#33](https://github.com/OWASP/pysap/pull/33)).
- `examples/router_fingerprints.json`: Added fingerprints for SAP Router 7450.34.25.5091 ([@jvis](https://x.com/jvis)).
- `examples/router_portfw.py`: Added route-string support ([@gloomicious](https://github.com/gloomicious), [#33](https://github.com/OWASP/pysap/pull/33)).
...
- `examples/diag_login_brute_force.py`: Handling valid users (e.g. no dialog users) vs valid passwords (fabhap).
...
- `bin/pysapcar`: Added a CLI option to select the extraction directory ([@okuuva](https://github.com/okuuva), [#24](https://github.com/OWASP/pysap/pull/24)).
- `pysap/SAPDiag.py`: Added support bits for SAP GUI 7.50 and SAP NW 7.52 SP01.
- `pysap/SAPCAR.py`: Fixed archive crafting by defaulting length fields to zero ([@okuuva](https://github.com/okuuva), [#22](https://github.com/OWASP/pysap/issues/22)).
- `pysap/SAPMS.py`: Added `DPInfo[1-3]` packets for Message Server `ADM` dispatcher/WP information ([@gelim](https://github.com/gelim), [@_chipik](https://x.com/_chipik), [#31](https://github.com/OWASP/pysap/pull/31)).
- `pysap/SAPRFC.py`: Added `SAPCPIC*` and `SAPRFXPG*` packets ([@gelim](https://github.com/gelim), [@_chipik](https://x.com/_chipik), [#31](https://github.com/OWASP/pysap/pull/31)).
...
- Use flake8 to find syntax errors and undefined names in Travis ([@cclauss](https://github.com/cclauss), [#20](https://github.com/OWASP/pysap/pull/20)).
...
- Added initial support for handling IGS (Internet Graphic Server) packets and example scripts ([@iggy38](https://github.com/iggy38), [#19](https://github.com/OWASP/pysap/pull/19)).
...
- `pysap/SAPDiagItems.py`, `extra/parsesupportbits.py`: Corrected support-bit field order ([@hnzlmnn](https://github.com/hnzlmnn), [#18](https://github.com/OWASP/pysap/pull/18)).
...
- `pysap/SAPMS.py`: Added Message Server Domain field and MS J2EE Cluster/Header/Service packets (Albert Zedlitz).
...
- `examples/diag_login_brute_force.py`: Detect invalid clients during login ([@hnzlmnn](https://github.com/hnzlmnn), [#17](https://github.com/OWASP/pysap/pull/17)).
...
- `pysap/SAPRouter.py`: Enhanced version retrieval when the server returns an error ([@gelim](https://github.com/gelim), [#11](https://github.com/OWASP/pysap/issues/11)).
- `pysap/SAPRouter.py`: Fixed missing eyecatchers in control messages ([@gelim](https://github.com/gelim), [#10](https://github.com/OWASP/pysap/pull/10)).
- `examples/diag_login_screen_info.py`: Script was improved by better printing technical information and
  outputting login screen text items (language, input fields, login text) ([@gelim](https://github.com/gelim), [#14](https://github.com/OWASP/pysap/pull/14)).
- `examples/diag_login_brute_force.py`: Script was improved to handle currently logged in users
  ([@hnzlmnn](https://github.com/hnzlmnn), [#16](https://github.com/OWASP/pysap/pull/16)).
- `example/router/admin.py`: Improved client list table display and fixed timestamps ([#12](https://github.com/OWASP/pysap/issues/12)).
  ([@gelim](https://github.com/gelim), [#12](https://github.com/OWASP/pysap/issues/12)).
- `examples/ms_dump_param.py`: New example script to list Message Server parameters and check them against a list of
  expected values ([@iggy38](https://github.com/iggy38), [#15](https://github.com/OWASP/pysap/pull/15)).
- `examples/ms_dos_exploit.py`: New example script to check for [CVE-2017-5997](https://web.archive.org/web/20180125175227/https://erpscan.com/advisories/erpscan-16-038-sap-message-server-http-remote-dos/)
  ...
  ([@vah13](https://github.com/vah13), [@gelim](https://github.com/gelim), [#10](https://github.com/OWASP/pysap/pull/10)).
...
- `examples/enqueue_dos_exploit.py`: New example script to check for [CVE-2016-4015](https://seclists.org/fulldisclosure/2016/Jul/44)
  ...
  ([@vah13](https://github.com/vah13), [#6](https://github.com/OWASP/pysap/pull/6)).
...
- Improvements over the `pysapcar` tool, general fixes, and multi-block SAP CAR
  archive handling (feedback from [Hans-Christian Esperer](https://github.com/hce)).
...
- `pysap/SAPRouter.py`: Documented version numbers from old releases ([invisiblethreat](https://github.com/invisiblethreat), [#3](https://github.com/OWASP/pysap/pull/3)).
- `pysapcompress/vpa108csulzh.cpp`: Improved the CVE-2015-2278 fix by initializing arrays ([ret5et](https://github.com/ret5et), [#4](https://github.com/OWASP/pysap/pull/4)).
